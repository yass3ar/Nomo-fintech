...
async function searchForApp(currentUrl, maxTries, ignoreAboutBlankUrl) {
    ...
    let retryCount = 0;
    return /** @type {import('../types').AppPage} */ (await (0, asyncbox_1.retryInterval)(maxTries, SELECT_APP_RETRY_SLEEP_MS, async () => {
        logApplicationDictionary.bind(this)();
...
function getPossibleDebuggerAppKeys(bundleIds) {
    if (bundleIds.includes(WILDCARD_BUNDLE_ID)) {
        ...
        return lodash_1.default.uniq(Object.keys((0, property_accessors_1.getAppDict)(this)));
    }
    ...
    for (const bundleId of possibleBundleIds) {
        ...
        for (const appId of (0, utils_1.appIdsForBundle)(bundleId, (0, property_accessors_1.getAppDict)(this))) {
