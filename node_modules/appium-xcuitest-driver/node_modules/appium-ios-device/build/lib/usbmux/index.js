...
const usbmux_decoder_js_1 = __importDefault(require("./transformer/usbmux-decoder.js"));
const usbmux_encoder_js_1 = __importDefault(require("./transformer/usbmux-encoder.js"));
...
try {
    ...
    ({ name, version } = require(path_1.default.resolve(__dirname, '..', '..', '..', 'package.json')));
}
catch (err) {
...
async function getDefaultSocket(opts = {}) {
    const { socketPath = DEFAULT_USBMUXD_SOCKET, socketPort = DEFAULT_USBMUXD_PORT, socketHost = DEFAULT_USBMUXD_HOST, timeout = 5000, } = opts;
    let socket;
...
class Usbmux extends base_service_1.BaseServiceSocket {
    constructor(socketClient) {
        super(socketClient);
        this._decoder = new usbmux_decoder_js_1.default();
        ...
        this._encoder = new usbmux_encoder_js_1.default();
    ...
    async connectLockdown(udid, timeout = 5000) {
        ...
        return new lockdown_1.Lockdown(new plist_service_1.default(socket));
    }
    /**
