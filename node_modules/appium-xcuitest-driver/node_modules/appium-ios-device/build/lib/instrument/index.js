...
class InstrumentService extends base_service_1.BaseServiceSocket {
    ...
    constructor(socketClient, event = null) {
        ...
        this._callbacks = new events_1.default.EventEmitter();
        this._channelCallbacks = new events_1.default.EventEmitter();
    ...
    async _callChannel(sync, channelCode, selector, ...auxiliaries) {
        ...
        this._encoder.write({
            ...
            channelCode,
            selector,
            auxiliaries: (auxiliaries.length === 1 && auxiliaries[0] instanceof headers_1.DTXMessageAuxBuffer) ? auxiliaries[0] : auxiliaries,
            identifier
        });
