...
class Unarchive {
    ...
    unpackArchiveHeader() {
        const plist = bplist_parser_1.default.parseBuffer(this.input)[0];
        const createPlistIssue = (/** @type {string} */ message) => {
            try {
                logger_1.default.debug(`Source plist: ${lodash_1.default.truncate(JSON.stringify(plist), { length: 250 })}`);
            }
            catch (ign) { }
